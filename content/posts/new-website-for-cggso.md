...
I use Visual Studio Code to generate, update websites with Hugo and push-pull to Githu but wthe organization needed a simple and effective CMS (content management system) for easily updating the website through an interface. I used [Forestry](https://forestry.io) as the CMS becasuse it supports both Hugo and Github, and has a clean interface. I finally hosted the website on [Netlify](https://www.netlify.com). I belive this is one of the best ways to create an ewffective and secure website without spending any money!
